...
int main(void) {
	...
	do{
		...
		case 2:
			...
			PedirFlotanteP(&precioAerolineas, "Ingrese el precio de Aerolineas\n", "El precio ingresado no es valido\n", 1,99999999);
		...
		case 3:
			...
			ConversorBitcoin(precioAerolineas, BITCOIN, &precioBitcoinAerolineas);
		...
		case 6:
			PedirEnteroP(&salida,"Si desea salir precione 6\n", "La opcion ingresada no es correcta\n", 1, 6);
			break;
